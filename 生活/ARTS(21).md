...
![](./_image/2019-03-16-09-48-53.jpg)
...
![](./_image/2019-03-16-09-50-03.jpg)
...
方案 `B` 非常成功，你也非常开心，但是你上述的不可能的数字感到非常疑惑。你非常想知道到底是什么回事，你在网络搜索网络上的数学家，发现了`Steve Steveington`，他是统计学家，而且就离你只有 `3.8` 里远，你希望他能够帮助弄明白是你疯了还是数学就是这样的。
"这就是`Simpon`悖论" `Steveington` 说道， "这个背后的数学非常无聊，仅仅是这个不等式是能成立的"。
![](./_image/2019-03-16-09-51-38.jpg)
